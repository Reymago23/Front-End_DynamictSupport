...
<title>dTs Admin | Empleados</title>
<!-- InstanceEndEditable -->
...
<hr>
<p>En este apartado podrá registrar nuevo empleado...</p>
<form method="post" action="../../Back-End_DynamictSupport/Insert_empleados.php" class="frm-servicio">
<div class="form-group">
	Nombre:
	<input type="text" required name="nombre" size="25" class="form-control" >
	Apellido:
	<input type="text" required name="apellido" size="25" class="form-control" >
Edad:
	<input type="number" required name="edad" size="25" class="form-control">
	Telefono:
	<input type="number" required pattern="[0-9]{11}" name="telefono" size="25" class="form-control">
	ID de Departamenos:
	<select name="idpuestodepartamento" class="form-control" required="">
	...
	<br>
	<input type="submit" value="Ingresar Datos" class="btn btn-primary">
